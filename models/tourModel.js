...
const tourSchema = new mongoose.Schema(
  {
    name: {
      ...
      unique: true,
      trim: true,
      maxlength: [40, 'Name must have less than 40 character'],
...
// QUERY MIDDLEWARE:
// All the event start with find will be triggered
// tourSchema.pre('findOne', function (next) { instead we can use /^find/
